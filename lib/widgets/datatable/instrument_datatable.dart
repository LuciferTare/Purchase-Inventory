...
import 'package:purchase_inventory/widgets/date_textfield.dart';
import 'package:purchase_inventory/widgets/textfield.dart';
...
class InstrumentDataTableState extends State<InstrumentDataTable> {
  ...
  final warrantyC = TextEditingController();
  final rateC = TextEditingController();
  final quantityC = TextEditingController();
  final totalcostC = TextEditingController();
  final discountedcostC = TextEditingController();
  final dateoforderC = TextEditingController();
  final dateofdeliveryC = TextEditingController();
        ...
        children: [
          ...
          Row(
            children: [
              ...
              CustomTextField(controller: warrantyC, labelText: 'Warranty'),
              const SizedBox(width: 10),
